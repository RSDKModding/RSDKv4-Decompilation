...
A complete decompilation of Retro Engine v4 (Sonic 1 And 2) Modded For Fan games and PV as a Whole.

# **SUPPORT THE OFFICIAL RELEASE OF SONIC 1 & 2**
+ Without These Ports RSDK-VT Couldn't Be a project.
...
* Added The Video Playback Feature From V3 and V5.
...
* Clone the repo with the following command: `git clone --recursive https://github.com/Sonic-Geared/RSDK-VT.git`
* Go into the repo you just cloned with `cd RSDK-VT`.
...
* Clone the repo and its other dependencies with the following command: `git clone --recursive [https://github.com/Sonic-Geared/RSDK-VT.git`
* Go into the repo you just cloned with `cd RSDK-VT`.
* Run `make -j5`.
...
* A Mac build of v1.3.0 (v4 Not VT) by [Sappharad](https://github.com/Sappharad) can be found [here](https://github.com/Sappharad/Sonic-1-2-2013-Decompilation/releases/tag/1.3.0mac).
...
this Fork is unofficial, RubberDuckyCooly or Anyone Involved With the RSDK Decomp can't provide support for this Build.
...
# Special Thanks (RSDK-VT)
* [Geared](https://github.com/Sonic-Geared) for helping Us Set this Github Up and Help with the Project.
* [RubberDuckyCooly](https://github.com/Rubberduckycooly) For the original [Sonic 1/2 Decomp Project](https://github.com/Rubberduckycooly/Sonic-1-2-2013-Decompilation)
# Contact:
Join the [Retro Engine Modding Discord Server](https://dc.railgun.works/retroengine) for any extra questions you may need to know about the og decompilation or modding.
Join the [Mobian Republic](https://discord.gg/Krnmh4NGdn) For updates on The game this was made for or just to chat with people.
