...
* If `devMenu` is enabled in the config, pressing `F8` and `F9` will visualize touch screen and object hitboxes, and `F10` will activate a palette overlay that shows the game's 8 internal palettes in real time.
