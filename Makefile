CXXFLAGS_ALL = $(shell pkg-config --cflags --static sdl sdl2 vorbisfile vorbis glew tinyxml2) $(CXXFLAGS) \
...
LDFLAGS_ALL = $(LDFLAGS)
LIBS_ALL = $(shell pkg-config --libs --static sdl sdl2 vorbisfile vorbis glew tinyxml2) -pthread $(LIBS)
